public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        imprimirRelatorio(t1, "Hash 1 (Soma)",
                fimInsercao1 - inicioInsercao1,
                fimBusca1 - inicioBusca1);

        System.out.println("\n");

        imprimirRelatorio(t2, "Hash 2 (Polinomial)",
    ...
    static void imprimirRelatorio(TabelaHash t, String nome, long tempoIns, long tempoBusca) {
        ...
        System.out.printf("Tempo de insercao    : %d ns%n", tempoIns);
        System.out.printf("Tempo de busca (%d)  : %d ns%n", TOTAL_BUSCAS, tempoBusca);
